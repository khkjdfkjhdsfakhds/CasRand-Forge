...
void main() {
  ...
  test('release metadata agrees on build 117', () {
    expect(File('pubspec.yaml').readAsStringSync(),
        contains('version: 0.9.10+117'));
    expect(
        File('.github/workflows/macos.yml').readAsStringSync(),
        contains(
            "CFBundleVersion' \"\$APP_PATH/Contents/Info.plist\")\" = \"117\""));
    expect(File('.github/workflows/android.yml').readAsStringSync(),
        contains("versionCode='117' versionName='0.9.10'"));
